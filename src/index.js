...
function isAllTrue(array, fn) {
    var falseCounter = 0, trueCounter = 0;
...
function isSomeTrue(array, fn) {
    ...
    if ((array.length <= 0) || (Object.prototype.toString.call(array) != '[object Array]')) {
        ...
        for (let i = 0; array.length > i; i++) {
            ...
            if (trueCounter > 0) {
                return true;
            } else if (falseCounter == array.length) {
                return false;
            }
        }
    }
...
function calculator() {
    var result = {
        sum: function (number = 0) {
            var [number, ...restArg] = arguments;
